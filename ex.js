...
client.on('message', async msg => {
    ...
    try {
        if (msg.body === '!ping reply') {
        ...
        } else if (msg.body.startsWith('!addmembers')) { // DO NOT, SPAM THIS !!!
        ...
        } else if (msg.body === '!location') { // MAYBE NOT WORKING
            ...
            chat.clearState();
        } else if (msg.body === '!jumpto') { //      INVALID  [ CRASHED SERVER, WILL BE COMMENTED LATER /* */ ]
            if (msg.hasQuotedMsg) {
                const quotedMsg = await msg.getQuotedMessage();
                client.interface.openChatWindowAt(quotedMsg.id._serialized);
            }
        } else if (msg.body === '!buttons') { //        BAN ABLE WILL BE COMMENTED LATER /* */
            let button = new Buttons('Button body', [{ body: 'bt1' }, { body: 'bt2' }, { body: 'bt3' }], 'title', 'footer');
            client.sendMessage(msg.from, button);
        } else if (msg.body === '!list') {         //   BAN ABLE  WILL BE COMMENTED LATER /* */
            let sections = [
        ...
        } else if (msg.body === '!edit') {   // NOT WORKING, WILL BE COMMENTED AND WILL TRY TO FIND THE SOLUTION
            if (msg.hasQuotedMsg) {
                const quotedMsg = await msg.getQuotedMessage();
                if (quotedMsg.fromMe) {
        ...
        } else if (msg.body === '!removelabels') {      // ONLY BUSINESS ACCOUNT SO, WILL BE COMMENTED 
            const chat = await msg.getChat();
        ...
        } else if (msg.body === '!howManyConnections') {        // CRASHING THE APP, WILL BE COMMENTED
            /**
